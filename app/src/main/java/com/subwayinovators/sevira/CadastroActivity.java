...
public class CadastroActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if(v == imgBack){
            startActivity(new Intent(CadastroActivity.this, Launcher.class));
        }

        if (v == btnFacebook) {
            LoginManager.getInstance().logInWithReadPermissions(CadastroActivity.this, Arrays.asList("email", "public_profile"));
            return;
        }
